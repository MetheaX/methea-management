package io.github.metheax.mgt.security;
...
public class SecurityConfiguration  extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfiguration(CustomAuthenticationService customAuthenticationService, MetheaPasswordEncoder encoder) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .and().addFilter(new MetheaAuthorizationFilter(authenticationManager()));
    }
